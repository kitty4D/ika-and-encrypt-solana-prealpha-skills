# Fee model (in-skill snapshot)

**Normative:** [Fee Model — Encrypt Developer Guide](https://docs.encrypt.xyz/reference/fees.html) · source `docs/src/reference/fees.md` in [`encrypt-pre-alpha`](https://github.com/dwallet-labs/encrypt-pre-alpha). **Live book wins**; refresh with [`docs-revision.md`](docs-revision.md).
...
| pending_gas_withdrawal | 8 | Pending SOL withdrawal amount |
