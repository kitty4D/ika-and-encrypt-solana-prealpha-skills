# Event reference (in-skill snapshot)

**Normative:** [Event Reference — Encrypt Developer Guide](https://docs.encrypt.xyz/reference/events.html) · source `docs/src/reference/events.md` in [`encrypt-pre-alpha`](https://github.com/dwallet-labs/encrypt-pre-alpha). **Live book wins**; refresh with [`docs-revision.md`](docs-revision.md).
