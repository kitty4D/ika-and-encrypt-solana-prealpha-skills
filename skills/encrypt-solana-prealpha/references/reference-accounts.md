# Account reference (in-skill snapshot)

**Normative:** [Account Reference — Encrypt Developer Guide](https://docs.encrypt.xyz/reference/accounts.html) · source `docs/src/reference/accounts.md` in [`encrypt-pre-alpha`](https://github.com/dwallet-labs/encrypt-pre-alpha). **Live book wins**; refresh with [`docs-revision.md`](docs-revision.md).
